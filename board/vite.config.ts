...
// The board imports @handshake/resolver + @handshake/shared as TypeScript source
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      "@handshake/shared": resolve(repoRoot, "packages/shared/src/index.ts"),
      "@handshake/resolver": resolve(repoRoot, "services/resolver/src/index.ts"),
